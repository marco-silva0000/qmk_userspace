...
// 	KC_BSPC,MT(MOD_LGUI, KC_A),	MT(MOD_LALT, KC_S),	MT(MOD_LCTL, KC_D),	MT(MOD_LSFT, KC_F),	KC_G,			KC_H,	MT(MOD_LSFT, KC_J),	MT(MOD_LCTL, KC_K),	MT(MOD_LALT, KC_L),	MT(MOD_LGUI, KC_SCLN),	KC_QUOT,
// 	MOD_LSFT,KC_Z,				KC_X,				KC_C,				KC_V,				KC_B,			KC_N,	KC_M,				KC_COMM,			KC_DOT,				KC_SLSH,                KC_ESC,
...
[_COLEMAK] = LAYOUT(
	...
	KC_BSPC,		MT(MOD_LGUI, KC_A),	MT(MOD_LALT, KC_R),	MT(MOD_LSFT, KC_S),	MT(MOD_LCTL, KC_T),	KC_D,			KC_H,	MT(MOD_LCTL, KC_N),	MT(MOD_LSFT, KC_E),	MT(MOD_LALT, KC_I),	MT(MOD_LGUI, KC_O),	KC_QUOT,
	MOD_LSFT,		KC_Z,				KC_X,				KC_C,				KC_V,				KC_B,			KC_K,	KC_M,				KC_COMM,			KC_DOT,				KC_SLSH,			KC_ESC,
		LT(3,KC_DEL),		LT(1,KC_SPC),		KC_TAB,					KC_ESC,				KC_BSPC,			LT(2,KC_ENT)
),
 ...
 */
[_NAVNUM] = LAYOUT(
	KC_TAB,			KC_0,		KC_1,		    KC_2,			KC_3,	    KC_MINS,			KC_PGUP,	KC_HOME,KC_UP,		KC_END,			KC_INS, KC_BSPC,
	KC_BSPC,		KC_SLSH,	KC_4,		    KC_5,		    KC_6,	    KC_PLUS,			KC_PGDN,	KC_LEFT,KC_DOWN,	KC_RIGHT,		KC_DEL,	KC_QUOT,
	MOD_LSFT,		KC_ASTR,	KC_7,			KC_8,			KC_9,		KC_EQL,				KC_NO,		KC_NO,	KC_NO,		KC_NO,			KC_NO,  KC_ESC,
			LT(3,KC_DEL),	LT(1,KC_SPC),	KC_TAB,		KC_ESC,	KC_BSPC,	LT(2,KC_ENT)
),
 ...
 */
[_FUNC] =  LAYOUT(
	KC_TAB,			STR1,	MS_BTN1,	MS_UP,			MS_BTN2,KC_NO,			KC_F1,	KC_F2,	KC_F3,	KC_F4,	KC_F5,        	KC_BSPC,
	KC_BSPC,		KC_CAPS,MS_LEFT,	MS_DOWN,		MS_RGHT,KC_PSCR,			KC_F6,	KC_F7,	KC_F8,	KC_F9,	KC_F10,  	KC_QUOT,
	MOD_LSFT,		QK_BOOT,KC_NO,		KC_NO,			KC_NO,	KC_NO,	        KC_F11,	KC_F12,	KC_F13,	KC_F14, KC_F15,       	KC_ESC,
		LT(3,KC_DEL),	LT(1,KC_SPC),	KC_TAB,		KC_ESC,	KC_BSPC,	LT(2,KC_ENT)
),
};
